...
```bash
git remote add encore encore://typing-game-engine-d6hi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/typing-game-engine-d6hi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/typing-game-engine-d6hi/settings/integrations/github)
