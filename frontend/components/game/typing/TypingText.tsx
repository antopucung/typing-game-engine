            ...
            <span key={wordIndex} style={{ 
              ...
              {wordChars.map((char, charInWordIndex) => {
                ...
                if (currentCharIndex < typedText.length) {
                  ...
                  if (typedChar === char) {
                    ...
                    charStyle.boxShadow = isRecent
                      ? `0 0 15px ${baseGreen}80, 0 0 30px ${baseGreen}40, inset 0 0 8px ${baseGreen}60`
                      : `0 0 6px ${baseGreen}40`;
                    charStyle.transform = isRecent ? "scale(1.05)" : "scale(1)";
                    ...
                    charStyle.boxShadow = isRecent
                      ? `0 0 20px ${baseRed}90, 0 0 40px ${baseRed}50, inset 0 0 12px ${baseRed}70`
                      : `0 0 10px ${baseRed}60`;
                    charStyle.animation = isRecent ? "errorGradientShake 0.6s ease-in-out" : "none";
                    charStyle.transform = isRecent ? "scale(1.1) rotate(1deg)" : "scale(1)";
                  ...
                  charStyle.boxShadow = cursorVisible 
                    ? `0 0 20px ${cursorColor}90, 0 0 40px ${cursorColor}50, inset 0 0 12px ${cursorColor}60`
                    : `0 0 6px ${cursorColor}30`;
                ...
                if (comboEffect && currentCharIndex >= currentIndex - 10 && currentCharIndex < currentIndex) {
                  ...
                  charStyle.boxShadow = `0 0 25px ${theme.colors.accent}90, 0 0 50px ${theme.colors.primary}60`;
                }
                ...
                if (spaceIndex < typedText.length) {
                  ...
                  if (typedChar === ' ') {
                    ...
                    spaceStyle.boxShadow = isRecent
                      ? `0 0 12px ${baseGreen}50`
                      : `0 0 4px ${baseGreen}30`;
